...
| OPNsense / Suricata | Syslog → Agent gest-srv | `v11-log-suricata-*` | ✅ 1 delayed (normal) |
...
> ℹ️ Le statut "1 delayed" sur OPNsense (10.100.1.254) est normal — il reflète la latence du pipeline syslog-ng et non une déconnexion réelle.
